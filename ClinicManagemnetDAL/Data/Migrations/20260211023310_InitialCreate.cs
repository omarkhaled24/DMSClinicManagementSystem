        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidEmailCheck2", "Email Like '_%@_%._%'");
                    table.CheckConstraint("GymUserValidPhoneNumberCheck2", "PhoneNumber Like '01%' and PhoneNumber Not Like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidPhoneNumberCheck1", "PhoneNumber Like '01%' and PhoneNumber Not Like '%[^0-9]%'");
                    table.ForeignKey(
